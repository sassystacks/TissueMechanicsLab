...
if __name__ == '__main__':
    a = extract_raw(directory='/home/richard/MyProjects/CardioVascularLab/rawCSVfail/AAA20171003_LA3U.CSV',stepforward='20',smooth_width=79).visualizeData()
